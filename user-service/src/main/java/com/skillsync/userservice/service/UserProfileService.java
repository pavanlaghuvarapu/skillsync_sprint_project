...
//        String imageUrl = "http://localhost:8080/api/users/images/" + filename;
//        UserProfile profile = repository.findByEmail(email).orElse(new UserProfile());
//        profile.setEmail(email);
